...
閉塞に至った事例（初期流速 \qtylist{0.0;0.1;0.2}{\meter.\day^{-1}}）を \cref{Fig:10m_01md,Fig:10m_02md} に示す．
これらを見ると，小半径のケースと比較して，各凍結管を中心とした同心円状に凍結前線が成長しており，熱拡散支配的な挙動を示していることがわかる．

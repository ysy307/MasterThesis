...
\end{equation}
ここで，$v$ は初期流速 [\unit{\meter\per\day}]，$a, b, c$ はフィッティングパラメータである．\cref{Eq:hyperbolic_fitting} において，垂直漸近線は $V = V_\mathrm{crit}^\mathrm{n}$ に位置する．したがって，このパラメータは数値的に導出された限界流速 $V_\mathrm{crit}^\mathrm{n}$ と定義される．
